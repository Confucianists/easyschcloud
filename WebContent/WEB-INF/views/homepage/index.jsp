...
<script type="text/javascript">
	...
	function sizeinit(){
		var bdheight=window.screen.availHeight;
		var bd=document.getElementById("rebody");
		var fill=document.getElementById("filldiv");
		bd.style.height=bdheight*0.8+"px";
		fill.style.height=bdheight*0.61+"px";
	}
...
.backdiv {
	background: url('${ctx}/static/manage/images/desktop.jpg') no-repeat
		center;
	min-width: 938px;
	width: 100%;
	height: 700px;
...
.headtitle {
	/*background: rgba(0, 0, 0, 0)
		url("${ctx}/static/manage/images/indextitle1.png") no-repeat scroll
		215px 30px;*/
	height: 123px;
	width: 100%;
}
...
<body id="rebody">
	...
	<div class="centerdiv">
		...
		<div class="formdiv">
			<form id="form-id" action="${ctx}/userlogin" method="post"
				id="loginForm">
				<div class="formrow">
					<div class="inputdiv">
	...
	<div class="foot">
		...
		推荐浏览器:<a href="${ctx}/static/browser/ChromeStandalone_61.0.3163.79_Setup.exe"> Chrome </a>,<a href="${ctx}/static/browser/Firefox-55.0.3.6445-setup.exe"> Firefox </a>,以获得更佳体验
