...
<body>
	<div class="hlrow">
		<a>咨询管理</a> > <a class="nowpage"> 咨询学员</a>
	</div>
	<div class="hltable">
			...
			<table border="0" cellpadding="2" cellspacing="0">
				<thead>
					<tr>
						...
						<th style="width: 150px;">咨询日期</th>
						<th style="width: 60px;">意向度</th>
						<th style="width: 150px;">咨询课程</th>
						<th style="width: 80px;">责任人</th>
						<th style="width: 80px;">转化状态</th>
	...
	<script type="text/javascript">
		var pagin;
		var dataurl = "${ctx}/manage/will/willinglist";
		$(function() {
			init();
		});
