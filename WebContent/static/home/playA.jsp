...
<body>
	<div
		style="width: 800px; margin: auto; text-align: left; margin-top: 20px; margin-bottom: 20px; font-size: 16px;">安装工具介绍
	</div>
	...
	<script type="text/javascript">
		var flashvars = {
			f : 'http://lyftest-10013419.cossh.myqcloud.com/a.mp4',
			c : 0,
			b : 1
		};
		var params = {
